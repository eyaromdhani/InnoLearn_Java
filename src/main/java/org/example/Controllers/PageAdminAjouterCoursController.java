...
public class PageAdminAjouterCoursController {
    ...
    void onEnregistrerClick(ActionEvent event) {
        ...
        try {
            ...
            Cours nouveauCours = new Cours(titre, description, slug, typeMedia, mediaUrl, duree, niveau, LocalDateTime.now(), "Admin", categorie.getId());
