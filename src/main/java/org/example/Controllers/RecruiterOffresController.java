...
public class RecruiterOffresController {
    ...
    private void openEditPopup(OffreStage o) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AddOffreForm.fxml"));
    ...
    void handleBack(ActionEvent event) {
        try {
            javafx.scene.Parent root = javafx.fxml.FXMLLoader.load(getClass().getResource("/RecruiterDashboard.fxml"));
