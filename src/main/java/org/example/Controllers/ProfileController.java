...
import org.example.Services.ServiceExperience;
...
public class ProfileController implements Initializable {
    ...
    private void loadExperiences() {
        ...
        try {
            ...
            for (int i = 0; i < experiences.size(); i++) {
                ...
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/ExperienceItem.fxml"));
    ...
    private void handleGenerateCV(ActionEvent event) {
        ...
        try {
            // Générer Accroche IA
            ServiceGroq aiService = new ServiceGroq();
